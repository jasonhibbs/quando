export const TIMEZONES: {
  ...
  },
  {
    ...
    zones: [
      ...
      { value: 'America/Knox_IN', label: 'Knox' },
  ...
  },
  {
    label: 'Canada',
    zones: [
      { value: 'Canada/Atlantic', label: 'Atlantic' },
      { value: 'Canada/Central', label: 'Central' },
      { value: 'Canada/East-Saskatchewan', label: 'East Saskatchewan' },
      { value: 'Canada/Eastern', label: 'Eastern' },
      { value: 'Canada/Mountain', label: 'Mountain' },
      { value: 'Canada/Newfoundland', label: 'Newfoundland' },
      { value: 'Canada/Pacific', label: 'Pacific' },
      { value: 'Canada/Saskatchewan', label: 'Saskatchewan' },
      { value: 'Canada/Yukon', label: 'Yukon' },
    ],
  },
  {
    label: 'Chile',
    zones: [
      { value: 'Chile/Continental', label: 'Continental' },
      { value: 'Chile/EasterIsland', label: 'Easter Island' },
    ],
  },
  // {
  //   "label": "Etc",
  ...
  // Our labels do not use POSIX signs, to reduce confusion.
  // From the IANA tz DB:
